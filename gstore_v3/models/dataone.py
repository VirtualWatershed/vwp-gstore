...
class DataoneDataObject(Base):
    ...
    def generate_object(self, output_path, obsolete_uuid, epsg=None, mongo_uri=None, metadata_info={}):  
        ...
        the obsolete uuid has to be NEW and inactive while we're generating everything
        ...
        Example:
            ...
            op = '/home/path/d1/datasets'

            metadata_info = {"app": "dataone", 
            "distribution_links": [{"link": '%s/dataone/v1/object/%s' % ('http://mysite.com', n.uuid), "type": "zip", "size": 0}], 
                "onlinks": ['%s/dataone/v1/object/%s' % ('http://mysite.com', n.uuid)], 
...
class DataoneObsolete(Base): 
    ...
    #TODO: shift this to the db for performance
