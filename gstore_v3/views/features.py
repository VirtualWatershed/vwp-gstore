...
#TODO: something about how to handle the multiple things per geom plus the tabular no geom uuid issue.
...
def feature(request):
    ...
    #TODO: also, i don't think this functions anyway.
...
@view_config(route_name='add_features', request_method='PUT', renderer='json')
...
@view_config(route_name='add_feature_attributes', request_method='PUT', renderer='json')
def add_attributes(request):
    ...
    #TODO: add a check against the record_count/feature_count in datasets and the
    #      final count(docs) in mongo and the insert list
    #      EXCEPT THIS COULD BE A PIECEMEAL BULK INSERT SO FALSE NEGATIVES!
