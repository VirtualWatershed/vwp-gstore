...
class Source(Base):
    """source data specification for file-based data
...
class SourceFile(Base):
    """source file definitions for files related to a source object

    a source object for a TIF could include the .tif, .tfw, .ovr, etc
    so this lists all files related to the source and that should be
    packed in the zip
...
class MapfileSetting(Base):
    ...
    def __init__(self, values):
        ...
        Args:
            values (dict): list of values to store in the hstore field
